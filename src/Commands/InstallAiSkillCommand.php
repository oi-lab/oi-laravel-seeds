...
{
    protected $signature = 'oi-seeds:install-ai-skill';

    protected $description = '[Deprecated] Use `oi:skills` instead. Install AI assistant skill files for oi-laravel-seeds';

    private const SKILL_NAME = 'oilab-laravel-seeds';

    private const SECTION = 'oi-lab/oi-laravel-seeds rules';
    ...
    private function addSkillToClaudeMd(): void
    {
        ...
        if (! file_exists($claudeMdPath)) {
            ...
            $this->info('Created CLAUDE.md with oi-laravel-seeds rules.');
        ...
        if (! str_contains($content, $sectionHeader)) {
            ...
            $this->info('Added oi-laravel-seeds rules section to CLAUDE.md.');
        ...
        $this->info('Updated oi-laravel-seeds rules section in CLAUDE.md.');
    }
}
